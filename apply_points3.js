...
// Raised the top head points by about 3-4% (lower y value) to ensure it captures all hair/head.
const p1 = [
  [0, 100], [0, 60], [2.5, 52], [5.5, 45], [9.8, 38], [12, 28], 
  [16.5, 24], [20.5, 26], [23.7, 36], [26.5, 45], [29.7, 54], [31, 68], 
  [28.5, 85], [26.4, 100]
];

const p2 = [
  [26.4, 100], [28.5, 85], [31, 68], [29.7, 54], [31, 45], [34.5, 38], 
  [37, 31], [39.7, 28], [43, 31], [44.9, 38], [47, 45], [49.4, 54], [50, 68], 
  [48, 85], [46.1, 100]
];

const p3 = [
  [46.1, 100], [48, 85], [50, 68], [47.9, 54], [50, 45], [51.4, 38], 
  [55, 28], [59.7, 26], [64, 28], [68.0, 38], [69, 45], [69.6, 54],
  [68, 68], [67, 85], [66.2, 100]
];

const p4 = [
  [66.2, 100], [67, 85], [68, 68], [66.2, 54], [69, 45], [74, 36], 
  [76.6, 27], [82.6, 21], [86.6, 23], [88.6, 30], [92, 40], [95, 47], 
