...
const features = [
  ...
  },
  {
    ...
    description: "Συνοδεύεται από διαδραστικές ασκήσεις, εννοιολογικούς χάρτες, φύλλα αξιολόγησης και οδηγίες μέσω QR codes. Μειώνει τον χρόνο προετοιμασίας και προσφέρει έτοιμο υλικό διαφοροποίησης."
  },
  {
...
export default function GeneralBenefits() {
  return (
    <section className="py-32 bg-[#080812] relative z-10">
